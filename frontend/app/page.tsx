      ...
      >
        ...
        <div className="flex items-center gap-1 md:gap-2">
          <select
            ...
            className="bg-gray-800 hover:bg-gray-700 text-xs md:text-sm text-gray-300 px-2 py-1 rounded-md border border-white/5 outline-none cursor-pointer"
      ...
      <DemoBanner
        message={
          analysis?.providerError
            ? `⚠️ ${analysis.providerError}`
            : analysis?.demoMessage || '⚠️ IA no disponible. Para probar correcciones con IA: ollama pull qwen2.5-coder:1.5b'
        }
        isVisible={demoMode}
              ...
              {analysis.errores.length > 0 ? (
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="py-2.5 px-3 bg-gray-800 hover:bg-gray-700 rounded-md text-sm transition"
